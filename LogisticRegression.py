...
#X_train = pca.fit_transform(ohe_train)
#X_test = pca.transform(ohe_test)
#%%
...
clf = LogisticRegression(random_state=0,max_iter=10000).fit(train, y_labels_train)

clf.predict(test)
clf.predict_proba(test)
clf.score(test, y_label_test)
print(clf.score(test, y_label_test))
